...
STAGED_HELP_CONTENT_RU="$STAGE_DIR/ProxyVault.app/Contents/Resources/app/help/content_ru.md"
STAGED_HELP_WELCOME_RU="$STAGE_DIR/ProxyVault.app/Contents/Resources/app/help/welcome_ru.md"
...
assert_file_exists "$STAGED_HELP_CONTENT_RU" "Staged Russian help content"
assert_file_exists "$STAGED_HELP_WELCOME_RU" "Staged Russian welcome content"
